...
vector<string> creditPayments(int a, int b, string startDate, string endDate, vector<string> historyStrings) {
...
int main() {
  //cout <<creditPayments(10000, 1000, "01/2019", "08/2019", {"$1000 payment received on 01/16/2019","$2400 payment received on 03/20/2019","$4000 payment received on 04/25/2019","$3300 payment received on 05/06/2019","$1500 payment received on 08/15/2019"}) <<endl;
} 